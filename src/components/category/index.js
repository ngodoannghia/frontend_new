...
import { apiGetPageAllCategory, displayDateTime } from "../../services/ApiService"
...
function IndexCategory(props) {
    ...
    useEffect(()=>{
        ...
        trackPromise(apiGetPageAllCategory({...filterOption} ).then((data)=>{
    ...
    function setFilterOption(obj){
        ...
        trackPromise(apiGetPageAllCategory(obj).then((data)=>{
              setDatasource(data.content);
              var totalPage = data["totalPages"];
              var pages = [1];
            ...
            <div className="row g-3">
                ...
                <div className="col-auto">
                    <div className="d-flex align-items-center gap-2 justify-content-lg-end">
                        ...
                        <a href={baseurl + '/category/add'}><button className="btn btn-primary px-4"><i className="bi bi-plus-lg me-2"></i>Add Category</button></a>
                    </div>
                </div>
            </div>
