...
import { apiAddCountry } from "../../services/ApiService"
...
function AddCountry(props) {
    ...
    function handleAdd(){
        ...
        try{
            apiAddCountry(formData).then((data) => {
                window.showAlert("Tạo country thành công !")
                props.history.push('/country')
            }).catch(e => {
                window.showAlert("Tạo country thất bại")
                console.log(e)
            })
        }
        catch{
                ...
                <div className="col-12 col-lg-8">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="mb-4">
                                <h5 className="mb-3">Country Description</h5>
