...
import { apiGetPageAllAlbum, displayDateTime } from "../../services/ApiService"
import { trackPromise } from 'react-promise-tracker';
import { withRouter } from "react-router";

function IndexAlbum(props) {
    ...
    useEffect(()=>{
        ...
        trackPromise(apiGetPageAllAlbum({...filterOption} ).then((data)=>{
    ...
    function setFilterOption(obj){
        ...
        trackPromise(apiGetPageAllAlbum(obj).then((data)=>{
              setDatasource(data.content);
              var totalPage = data["totalPages"];
              var pages = [1];
            ...
            <td>
                <div className="d-flex align-items-center gap-3">
                    ...
                    <div className="product-info">
                        ...
                        <p className="mb-0 product-category">Singer : 
                            {
                                m.singers.map(s => (
                                    <span key={s.singer_id}>{s.name}</span>
                                ))
                            }
                        </p>
                    </div>
            ...
            <div className="row g-3">
                ...
                <div className="col-auto">
                    <div className="d-flex align-items-center gap-2 justify-content-lg-end">
                        ...
                        <a href={baseurl + '/album/add'}><button className="btn btn-primary px-4"><i className="bi bi-plus-lg me-2"></i>Add Album</button></a>
                    </div>
                </div>
            </div>
