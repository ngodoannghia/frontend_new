        ...
        <aside className="mini-sidebar d-flex align-items-center flex-column justify-content-between">
            ...
            <div className="quick-menu ps">
                <nav className="nav flex-column gap-1">
                    ...
                    <a className="nav-link" href="javascript:;"><i className="material-icons-outlined">apps</i></a>
                    <a className="nav-link" href="ecommerce-products.html"><i
                        className="material-icons-outlined">shopping_cart</i></a>
                    <a className="nav-link" href="javascript:;"><i className="material-icons-outlined">forum</i></a>
                    <a className="nav-link" href="javascript:;"><i className="material-icons-outlined">event</i></a>
                </nav>
