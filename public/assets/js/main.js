  ...
  /* scrollar */
    var elementScroll = document.querySelector(".quick-menu");
    if (elementScroll){
      new PerfectScrollbar(".quick-menu")
    }
    
    var elementScroll = document.querySelector(".notify-list");
    if (elementScroll){
      new PerfectScrollbar(".notify-list")
    }
    
    var elementScroll = document.querySelector(".search-content");
    if (elementScroll){
